...
if(!empty($_POST['u'])) {
	foreach ($_POST['u'] as $uid) {
		$id = filter($uid);
		$db->exec("delete from students where student_id='$id' and `user_name` <> 'admin'") or die(mysql_error());
	}
 }
...
$footer_scripts = array("assets/js/settings.js","assets/js/admin.js","assets/js/register.js");
