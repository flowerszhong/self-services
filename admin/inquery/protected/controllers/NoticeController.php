...
class NoticeController extends Controller {
	 ...
	 */
	public $layout = '//layouts/notice-column2';
	...
	public function actionCreate() {
		...
		if (isset($_POST['Notice'])) {
			$_POST['Notice']['create_time'] = date("Y-m-d H:i:s");
			$_POST['Notice']['update_time'] = date("Y-m-d H:i:s");
			$_POST['Notice']['author'] = Yii::app()->user->name;
