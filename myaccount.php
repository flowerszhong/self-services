...
";
    ...
    $rs_all = mysql_query("select count(*) as total_all from students") or die(mysql_error());
    $rs_active = mysql_query("select count(*) as total_active from students where approved='1'") or die(mysql_error());
    $rs_total_pending = mysql_query("select count(*) as total_pending from students where approved='0'");
    
    $rs_available = mysql_query("select count(*) as total_availiable from students where net_id<>'' and net_pwd <>'' ") or die(mysql_error());
    // $datenow = "2014-11-01";
    // $rs_expire = mysql_query("select count(*) as total_expire from students where expire_date >") or die(mysql_error());
    // print_r($rs_expire);
    ...
    $sep_13_rows = mysql_query($sep_13) or die(mysql_error());
    $sep_14_rows = mysql_query($sep_14) or die(mysql_error());
    $oct_13_rows = mysql_query($oct_13) or die(mysql_error());
    $oct_14_rows = mysql_query($oct_14) or die(mysql_error());
    $nov_13_rows = mysql_query($nov_13) or die(mysql_error());
    $nov_14_rows = mysql_query($nov_14) or die(mysql_error());
    $dec_13_rows = mysql_query($dec_13) or die(mysql_error());
    $dec_14_rows = mysql_query($dec_14) or die(mysql_error());
    
    
    $sep_13_count = mysql_fetch_row($sep_13_rows);
    $sep_14_count = mysql_fetch_row($sep_14_rows);
    $oct_13_count = mysql_fetch_row($oct_13_rows);
    $oct_14_count = mysql_fetch_row($oct_14_rows);
    $nov_13_count = mysql_fetch_row($nov_13_rows);
    $nov_14_count = mysql_fetch_row($nov_14_rows);
    $dec_13_count = mysql_fetch_row($dec_13_rows);
    $dec_14_count = mysql_fetch_row($dec_14_rows);
    
    
    list($total_pending) = mysql_fetch_row($rs_total_pending);
    list($all) = mysql_fetch_row($rs_all);
    list($active) = mysql_fetch_row($rs_active);
    list($available) = mysql_fetch_row($rs_available);
...
if (!checkAdmin()) {
    ...
    $select_result = mysql_query($sql_select) or die(mysql_error());
