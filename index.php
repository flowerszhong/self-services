...
<div class="container">
    ...
    <form class="form-signin" action="index.php" method="post" id="login-form" name="logForm">
        <label>学号</label>
        <input type="text" name="student_id" class="form-control login-input" placeholder="学号" required="" autofocus="">
        <label>密码</label>
        <input type="password" name="pwd" class="form-control login-input" placeholder="密码" required="">
